...
class VersionManager:
    ...
    def _load_versions(self) -> Dict[str, Version]:
        ...
        try:
            ...
            raise VersionError(f"Invalid version file: {e}")
    ...
    def _load_compatibility(self) -> Dict[str, List[str]]:
        ...
        try:
            ...
            raise VersionError(f"Invalid compatibility file: {e}")
    ...
    def validate_component(self, component: str, version: str) -> bool:
        ...
        except ValueError as e:  # pragma: no cover - Version.from_string wraps parse failures
